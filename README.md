...
The apps comes with pre-compiled sigma rules in its savedsearches.conf but the philosophy of the project is to allow you to easily import any ruleset you want with the pysigma pipelines provided, see [Sigma Rules Support](#sigma-rules-support)
